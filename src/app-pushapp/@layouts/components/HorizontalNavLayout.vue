<script setup>
import { HorizontalNav } from "@app-pushapp/@layouts/components";
import { useLayouts } from "@app-pushapp/@layouts/composable/useLayouts";
...
<style lang="scss">
@use "@app-pushapp/styles/variables/_template.scss" as variables;
@use "@app-pushapp/@layouts/styles/placeholders";
@use "@app-pushapp/@layouts/styles/mixins";
