<script setup>
import * as demoCode from "@app-pushapp/views/demos/forms/tables/simple-table/demoCodeSimpleTable";
</script>
...
<template>
  <VRow>
    ...
    <VCol cols="12">
      <AppCardCode title="Theme" :code="demoCode.theme">
        <p>use <code>theme</code> prop to switch table to the dark theme.</p>
    ...
    <VCol cols="12">
      <AppCardCode title="Height" :code="demoCode.height">
        <p>
