<script setup>
import * as demoCode from "@app-pushapp/views/demos/components/progress-circular/demoCodeProgressCircular";
</script>
...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      <AppCardCode title="Indeterminate" :code="demoCode.indeterminate">
        <p>
          ...
          <code>v-progress-circular</code> continues to animate indefinitely.
        </p>
    ...
    <VCol cols="12" md="6">
      <AppCardCode title="Rotate" :code="demoCode.rotate">
        <p>
    ...
    <VCol cols="12" md="6">
      <AppCardCode title="Size" :code="demoCode.size">
        <p>
          ...
          alter the size and width of the
          <code>v-progress-circular</code> component.
        </p>
