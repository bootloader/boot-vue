<script setup>
import ChartJsBarChart from "@app-pushapp/views/charts/chartjs/ChartJsBarChart.vue";
import ChartJsBubbleChart from "@app-pushapp/views/charts/chartjs/ChartJsBubbleChart.vue";
import ChartJsHorizontalBarChart from "@app-pushapp/views/charts/chartjs/ChartJsHorizontalBarChart.vue";
import ChartJsLineAreaChart from "@app-pushapp/views/charts/chartjs/ChartJsLineAreaChart.vue";
import ChartJsLineChart from "@app-pushapp/views/charts/chartjs/ChartJsLineChart.vue";
import ChartJsPolarAreaChart from "@app-pushapp/views/charts/chartjs/ChartJsPolarAreaChart.vue";
import ChartJsRadarChart from "@app-pushapp/views/charts/chartjs/ChartJsRadarChart.vue";
import ChartJsScatterChart from "@app-pushapp/views/charts/chartjs/ChartJsScatterChart.vue";
...
<template>
  <VRow id="chartjs-wrapper">
    ...
    <VCol cols="12">
      <VCard title="Statistics" subtitle="Commercial networks and enterprises">
        <VCardText>
