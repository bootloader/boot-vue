<script setup>
import PersonalDetails from "@app-pushapp/views/wizard-examples/property-listing/PersonalDetails.vue";
import PriceDetails from "@app-pushapp/views/wizard-examples/property-listing/PriceDetails.vue";
import PropertyArea from "@app-pushapp/views/wizard-examples/property-listing/PropertyArea.vue";
import PropertyDetails from "@app-pushapp/views/wizard-examples/property-listing/PropertyDetails.vue";
import PropertyFeatures from "@app-pushapp/views/wizard-examples/property-listing/PropertyFeatures.vue";
