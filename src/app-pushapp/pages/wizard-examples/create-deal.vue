<script setup>
import DealDetails from "@app-pushapp/views/wizard-examples/create-deal/DealDetails.vue";
import DealReviewComplete from "@app-pushapp/views/wizard-examples/create-deal/DealReviewComplete.vue";
import CreateDealType from "@app-pushapp/views/wizard-examples/create-deal/DealType.vue";
import DealUsage from "@app-pushapp/views/wizard-examples/create-deal/DealUsage.vue";
