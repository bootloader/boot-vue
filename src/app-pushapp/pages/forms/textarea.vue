<script setup>
import * as demoCode from "@app-pushapp/views/demos/forms/form-elements/textarea/demoCodeTextarea";
</script>
  ...
  <VRow class="match-height">
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Basic" :code="demoCode.basic">
        <p>
          v-textarea in its simplest form is a multi-line text-field, useful for
    ...
    <VCol cols="12">
      ...
      <AppCardCode title="Variant" :code="demoCode.variant">
        <p>
          Use <code>filled</code>, <code>plain</code>, <code>outlined</code>,
          <code>solo</code> and <code>underlined</code> option of
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="States" :code="demoCode.states">
        <p>
          Use <code>disabled</code> and <code>readonly</code> prop to change the
          state of textarea.
        </p>
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Counter" :code="demoCode.counter">
        <p>
          The <code>counter</code> prop informs the user of a character limit
          for the <code>v-textarea</code>.
        </p>
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Icons" :code="demoCode.icons">
        <p>
          The <code>append-icon</code>, <code>prepend-icon</code>,
          <code>append-inner-icon</code> and
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Rows" :code="demoCode.rows">
        <p>
          The <code>rows</code> prop allows you to define how many rows the
          textarea has, when combined with the <code>row-height</code> prop you
          can further customize your rows by defining their height.
        </p>
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="No resize" :code="demoCode.noResize">
        <p>
          ...
          regardless of their content's size, using the
          <code>no-resize</code> prop.
        </p>
