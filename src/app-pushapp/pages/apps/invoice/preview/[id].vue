...
// Components
import InvoiceAddPaymentDrawer from "@app-pushapp/views/apps/invoice/InvoiceAddPaymentDrawer.vue";
import InvoiceSendInvoiceDrawer from "@app-pushapp/views/apps/invoice/InvoiceSendInvoiceDrawer.vue";

// Store
import { useInvoiceStore } from "@app-pushapp/views/apps/invoice/useInvoiceStore";
        ...
        <VCard>
          ...
          <VTable class="invoice-preview-table">
            ...
            <tbody>
              <tr v-for="item in purchasedProducts" :key="item.name">
                ...
                <td class="text-center">${{ item.cost * item.qty }}</td>
              </tr>
            </tbody>
          </VTable>
          ...
          <VCardText>
            <div class="d-flex mx-sm-4">
              <h6 class="text-base font-weight-medium me-1">Note:</h6>
              <span
