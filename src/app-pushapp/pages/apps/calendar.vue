...
import {
  blankEvent,
  useCalendar,
} from "@app-pushapp/views/apps/calendar/useCalendar";
import { useCalendarStore } from "@app-pushapp/views/apps/calendar/useCalendarStore";
import { useResponsiveLeftSidebar } from "@app-pushapp/@core/composable/useResponsiveSidebar";

// Components
import CalendarEventHandler from "@app-pushapp/views/apps/calendar/CalendarEventHandler.vue";
...
<style lang="scss">
@use "@app-pushapp/@core/scss/template/libs/full-calendar";
