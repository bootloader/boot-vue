...
import vuetifyInitialThemes from "@app-pushapp/plugins/vuetify/theme";
import ChatActiveChatUserProfileSidebarContent from "@app-pushapp/views/apps/chat/ChatActiveChatUserProfileSidebarContent.vue";
import ChatLeftSidebarContent from "@app-pushapp/views/apps/chat/ChatLeftSidebarContent.vue";
import ChatLog from "@app-pushapp/views/apps/chat/ChatLog.vue";
import ChatUserProfileSidebarContent from "@app-pushapp/views/apps/chat/ChatUserProfileSidebarContent.vue";
import { useChat } from "@app-pushapp/views/apps/chat/useChat";
import { useChatStore } from "@app-pushapp/views/apps/chat/useChatStore";
import { useResponsiveLeftSidebar } from "@app-pushapp/@core/composable/useResponsiveSidebar";
import { avatarText } from "@app-pushapp/@core/utils/formatters";
...
<style lang="scss">
@use "@app-pushapp/styles/variables/_vuetify.scss";
@use "@app-pushapp/@core/scss/base/_mixins.scss";
@use "@app-pushapp/@layouts/styles/mixins" as layoutsMixins;
