...
import sliderBar1 from "@app-pushapp/assets/images/illustrations/sidebar-pic-1.png";
import sliderBar2 from "@app-pushapp/assets/images/illustrations/sidebar-pic-2.png";
import sliderBar3 from "@app-pushapp/assets/images/illustrations/sidebar-pic-3.png";
    ...
    >
      <VCarouselItem v-for="item in websiteAnalytics" :key="item.name">
        <VCardText>
          <VRow>
            <VCol cols="12">
              <h5 class="text-h5 text-white mb-1">Website Analytics</h5>
