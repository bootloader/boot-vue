...
import type { CustomInputContent } from '@app-pushapp/@core/types'
...
export const customCheckboxesWithImage = {
  ts: `<script setup lang="ts">
import bg1 from '@app-pushapp/assets/images/pages/custom-checkbox-img-1.png'
import bg2 from '@app-pushapp/assets/images/pages/custom-checkbox-img-2.png'
import bg3 from '@app-pushapp/assets/images/pages/custom-checkbox-img-3.png'
...
export const customRadiosWithImage = {
  ts: `<script setup lang="ts">
import bg1 from '@app-pushapp/assets/images/pages/custom-radio-img-1.png'
import bg2 from '@app-pushapp/assets/images/pages/custom-radio-img-2.png'
import bg3 from '@app-pushapp/assets/images/pages/custom-radio-img-3.png'
