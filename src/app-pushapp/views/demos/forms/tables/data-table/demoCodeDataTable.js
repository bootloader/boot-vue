...
import data from '@app-pushapp/views/demos/forms/tables/data-table/datatable'
...
import { VDataTable } from 'vuetify/labs/VDataTable'
import { avatarText } from '@app-pushapp/@core/utils/formatters'
import type { Data } from '@app-pushapp/@fake-db/types'
import data from '@app-pushapp/views/demos/forms/tables/data-table/datatable'
...
export const kitchenSink = {
  ts: `<script setup lang="ts">
import { VDataTable } from 'vuetify/labs/VDataTable'
import type { SalesDetails } from '@app-pushapp/@fake-db/types'
