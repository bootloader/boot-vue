...
import pdf from "@app-pushapp/assets/images/icons/project-icons/pdf.png";
import pumaShoes from "@app-pushapp/assets/images/pages/puma-shoes.jpeg";
</script>
  ...
  <VCard title="Timeline Card">
    <VCardText>
      ...
      >
        ...
        <VTimelineItem>
          <template #icon>
            <VIcon size="20" icon="tabler-send" color="primary" />
          </template>

          <VCard class="bg-light-error" variant="text">
            <VCardText>
        ...
        <VTimelineItem>
          <template #icon>
            <VIcon size="20" icon="tabler-brush" color="success" />
          </template>

          <VCard class="bg-light-primary" variant="text">
            <VCardText>
              <div class="d-flex justify-space-between align-center mb-1">
              ...
              <div class="d-flex justify-space-between align-center">
                ...
                <span class="d-flex align-center">
                  <VAvatar size="40" :image="avatar2" class="me-2" />
        ...
        <VTimelineItem>
          <template #icon>
            <VIcon size="20" icon="tabler-basket" color="error" />
          </template>

          <VCard class="bg-light-info" variant="text">
            <!-- 👉 content -->
            <VCardText>
              <div class="d-flex justify-space-between align-center mb-1">
                <span class="app-timeline-title"
                  >Sold Puma POPX Blue Color</span
                >
                <span class="app-timeline-meta">January, 10</span>
              </div>

              <div
                class="d-flex align-sm-center flex-sm-row flex-column mb-3 gap-y-2"
              >
                <VImg
                  height="62"
                  width="62"
              ...
              <div
                class="d-flex justify-space-between flex-column flex-sm-row gap-3"
              >
        ...
        <VTimelineItem>
          <template #icon>
            <VIcon size="20" icon="tabler-user-circle" color="info" />
          </template>

          <VCard class="bg-light-success" variant="text">
            <VCardText>
