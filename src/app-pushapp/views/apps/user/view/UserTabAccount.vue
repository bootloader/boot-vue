...
import figma from "@app-pushapp/assets/images/icons/project-icons/figma.png";
import html5 from "@app-pushapp/assets/images/icons/project-icons/html5.png";
import python from "@app-pushapp/assets/images/icons/project-icons/python.png";
import react from "@app-pushapp/assets/images/icons/project-icons/react.png";
import sketch from "@app-pushapp/assets/images/icons/project-icons/sketch.png";
import vue from "@app-pushapp/assets/images/icons/project-icons/vue.png";
import xamarin from "@app-pushapp/assets/images/icons/project-icons/xamarin.png";
      ...
      <VCard title="User's Projects List">
        ...
        >
          ...
          <template #item.name="{ item }">
            <div class="d-flex">
              <VAvatar :size="34" class="me-3" :image="item.raw.logo" />
              <div>
          ...
          <template #bottom>
            ...
            >
              ...
              <VPagination
                ...
                :total-visible="
                  Math.ceil(projects.length / options.itemsPerPage)
                "
              >
