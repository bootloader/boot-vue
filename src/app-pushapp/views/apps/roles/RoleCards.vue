...
import avatar10 from "@app-pushapp/assets/images/avatars/avatar-10.png";
...
import avatar9 from "@app-pushapp/assets/images/avatars/avatar-9.png";
import girlUsingMobile from "@app-pushapp/assets/images/pages/girl-using-mobile.png";
        ...
        <VCardText class="d-flex align-center pb-1">
          ...
          <div class="v-avatar-group">
            <template v-for="(user, index) in item.users" :key="user">
              ...
              <VAvatar v-if="item.users.length === 4" size="36" :image="user" />
            </template>
            <VAvatar
