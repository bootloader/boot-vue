    ...
    <VCardText>
      ...
      >
        <VTimelineItem dot-color="warning" size="x-small">
          ...
          <div class="d-flex align-center mt-3">
            ...
            <div>
              ...
              <span class="app-timeline-meta"> CEO of Infidel </span>
            </div>
          </div>
        </VTimelineItem>
        ...
        <VTimelineItem dot-color="info" size="x-small">
          ...
          <p class="app-timeline-text mb-0">Sent by Mollie Dixon</p>
          <div class="d-flex align-center mt-3">
            <VIcon
              color="warning"
              ...
              class="me-2"
            />
            <h6 class="font-weight-medium text-xs me-3">App Guidelines</h6>

            <VIcon color="success" icon="tabler-table" size="20" class="me-2" />
            <h6 class="font-weight-medium text-xs">Testing Results</h6>
          </div>
        </VTimelineItem>
        ...
        <VTimelineItem dot-color="secondary" size="x-small">
          ...
          <p class="app-timeline-text mb-1">WooCommerce iOS App Completed</p>
        </VTimelineItem>
      </VTimeline>
    </VCardText>
  </VCard>
