...
import eCommerce2 from "@app-pushapp/assets/images/eCommerce/2.png";
import pages1 from "@app-pushapp/assets/images/pages/1.png";
import pages2 from "@app-pushapp/assets/images/pages/c2.png";
import pages3 from "@app-pushapp/assets/images/pages/c3.png";
import pages5 from "@app-pushapp/assets/images/pages/5.jpg";
import pages6 from "@app-pushapp/assets/images/pages/6.jpg";
    ...
    <VCol md="6" lg="8" cols="12">
      <VCard>
        <VRow no-gutters>
          <VCol cols="12" sm="8" md="12" lg="7" order="2" order-lg="1">
            ...
            <VCardText class="d-flex justify-center">
              ...
              <div class="ms-auto ps-4">
                ...
                <p class="d-flex align-center mb-0">
                  <VIcon color="primary" icon="tabler-trending-up" size="22" />
          ...
          >
            <div
              class="membership-pricing d-flex flex-column align-center py-14 h-100 justify-center"
            >
              <p class="mb-5">
      ...
      <VCard class="text-center">
        <VCardText class="d-flex flex-column justify-center align-center">
          <VAvatar color="primary" variant="tonal" size="50" class="mb-4">
            <VIcon size="2rem" icon="tabler-help" />
          </VAvatar>
