...
import txt from "@app-pushapp/assets/images/icons/file/txt.png";
import xls from "@app-pushapp/assets/images/icons/file/xls.png";
...
mock.onGet("/apps/email/emails").reply((config) => {
  const { q = "", filter = "inbox", label } = config.params;
